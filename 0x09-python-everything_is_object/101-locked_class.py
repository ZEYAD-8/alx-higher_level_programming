...
This module defines a Python class called LockedClass that demonstrates the use of __slots__
...
Usage:
    ...
    # Attempt to assign a value to a non-existent attribute (will raise an AttributeError)
    obj.last_name = "Doe"
"""
